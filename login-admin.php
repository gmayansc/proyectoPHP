  ...
  <div class="container">
    ...
    <section class="container justify-content-center row">
        <div class="student-info col-8 mt-5 mb-5">
            <h2 class="student-info__title mb-3">Iniciar sesión de Administrador</h2>
            <form class="row g-3"  action="login.php" method="POST">
                ...
                <div class="col-12">
                    ...
                    <p>¿Aún no tienes una cuenta? <a class="btn btn-primary" href="register-admin.php">Registrarse cómo Administrador</a><br>
